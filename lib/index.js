...
function useQueryClient(id = "") {
    var _a;
    const vm = (_a = vueDemi.getCurrentInstance()) === null || _a === void 0 ? void 0 : _a.proxy;
    if (!vm) {
    ...
    devtoolsApi.setupDevtoolsPlugin({
        ...
        api.on.getInspectorTree((payload) => {
            if (payload.inspectorId === pluginId) {
                ...
                const filtered = matchSorter.matchSorter(queries, payload.filter, {
                    keys: ["queryHash"],
...
function useBaseQuery(Observer, arg1, arg2 = {}, arg3 = {}) {
    ...
    const suspense = () => {
        return new Promise((resolve) => {
            ...
            run();
            vueDemi.watch([() => arg1, () => arg2, () => arg3], run, { deep: true });
        });
    };
    return Object.assign(Object.assign({}, vueDemi.toRefs(vueDemi.readonly(state))), { suspense });
    /**
...
function useQuery(arg1, arg2, arg3) {
    const result = useBaseQuery(queryCore.QueryObserver, arg1, arg2, arg3);
...
function useInfiniteQuery(arg1, arg2, arg3) {
    const result = useBaseQuery(queryCore.InfiniteQueryObserver, arg1, arg2, arg3);
